...
namespace Portfilo.Areas.Admin.Controllers
{
    ...
    {
        private readonly IRepository<CallToAction> menu;

        public CallToActionsController(IRepository<CallToAction> menu)
        {
            this.menu = menu;
        }
        ...
        public async Task<IActionResult> Create(CallToAction collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, CallToAction collection)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> Active(int id)
        {
            try
            {
                await menu.ActiveAsync(id, new CallToAction()
                {
