...
namespace Portfilo.Areas.Admin.Controllers
{
    ...
    {
        private readonly IRepository<SocialMedia> menu;

        public SocialMediasController(IRepository<SocialMedia> menu)
        {
            this.menu = menu;
        }
        ...
        public async Task<IActionResult> Create(SocialMedia collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, SocialMedia collection)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> Active(int id)
        {
            try
            {
                await menu.ActiveAsync(id, new SocialMedia()
                {
