...
namespace Portfilo.Areas.Admin.Controllers
{
    ...
    {
        private readonly IRepository<Education> menu;

        public EducationsController(IRepository<Education> menu)
        {
            this.menu = menu;
        }
        ...
        public async Task<IActionResult> Create(Education collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Education collection)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> Active(int id)
        {
            try
            {
                await menu.ActiveAsync(id, new Education()
                {
