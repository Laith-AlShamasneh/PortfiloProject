...
namespace Portfilo.Areas.Admin.Controllers
{
    ...
    {
        private readonly IRepository<Experience> menu;

        public ExperiencesController(IRepository<Experience> menu)
        {
            this.menu = menu;
        }
        ...
        public async Task<IActionResult> Create(Experience collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Experience collection)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> Active(int id)
        {
            try
            {
                await menu.ActiveAsync(id, new Experience()
                {
